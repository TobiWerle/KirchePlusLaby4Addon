...
public class HV_ADD {
    ...
    static String HV_prefix = Color.GRAY + "[" + Color.RED + "HV" + Color.GRAY + "]";
        ...
        Thread thread = new Thread(new Runnable() {
            ...
            public void run() {
                try {
                    ...
                    if (valueRange == null) {
                        KirchePlus.main.displayMessage(HV_prefix + Color.RED
                            + "Es wurde nicht genug Platz in der Hausverbots-Tabelle gefunden!");
                        return;
                    }
                    ...
                    KirchePlus.main.displayMessage(
                        HV_prefix + Color.GREEN + " Das Hausverbot wurde eingetragen!");
                    ...
                    if (e.getMessage().contains("400 Bad Request")) {
                        KirchePlus.main.displayMessage(HV_prefix + Color.RED
                            + "Du hast keine Rechte auf die Hausverbots-Tabelle");
                    }
                }
            }
        });
