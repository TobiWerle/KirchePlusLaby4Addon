...
public class customGUI_GD extends GuiScreen {
    ...
    @Override
    public void initGui() {
        GuiLabel label = new GuiLabel(fontRenderer, 1, width / 2 - 50, height / 2 - maxy, 50, 10,
            0xd943ff64);
        ...
        y = 25;
        GuiLabel label2 = new GuiLabel(fontRenderer, 3, width / 2 - 50, height / 2 - maxy + y, 90,
            10, 0xd943ff64);
        ...
        y = 50;
        GuiLabel label3 = new GuiLabel(fontRenderer, 3, width / 2 - 50, height / 2 - maxy + y, 90,
            10, 0xd943ff64);
        ...
        y = 75;
        GuiLabel label4 = new GuiLabel(fontRenderer, 3, width / 2 - 50, height / 2 - maxy + y, 90,
            10, 0xd943ff64);
        label4.addLine("GBK");
        ...
        y = 100;
        GuiLabel label5 = new GuiLabel(fontRenderer, 3, width / 2 - 50, height / 2 - maxy + y, 90,
            10, 0xd943ff64);
        ...
        y = 125;
        GuiLabel label6 = new GuiLabel(fontRenderer, 3, width / 2 - 50, height / 2 - maxy + y, 90,
            10, 0xd943ff64);
        ...
        y = 150;
        GuiLabel label7 = new GuiLabel(fontRenderer, 3, width / 2 - 50, height / 2 - maxy + y, 90,
            10, 0xd943ff64);
        ...
        y = 185;
        buttonList.add(
            new GuiButton(0, width / 2 - 50, height / 2 - maxy + y, 100, 20, "Bestätigen"));
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        fontRenderer.drawString("Gottesdienst Einteilungen", width / 2 - 61, height / 2 - 112,
            0xd943ff64);
        brg.drawTextBox();
        text.drawTextBox();
        vu.drawTextBox();
